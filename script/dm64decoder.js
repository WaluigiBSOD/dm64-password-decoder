...
var PasswordCharacters = "ABCDEFGHJKLMNPQRSTVWXY1234567890";
...
function _DecodePassword(Password = "") {
	...
	if (Password.length == 20) {
		...
		NameB = PasswordChunkMedium & 0xFF;
		PasswordChunkMedium >>= 8;

		NameC = PasswordChunkMedium & 0xFF;
		PasswordChunkMedium >>= 8;

		NameD = PasswordChunkMedium & 0xFF;

		NameA = PasswordChunkHigh & 0xFF;
		PasswordChunkHigh >>= 8;
		...
		TestCheckSum += NameA + NameB + NameC + NameD;
		TestCheckSum &= 0x3FF;
		...
		if (CheckSum == TestCheckSum) {
			...
			while (NameB.toString().length < 3)
				NameB = "0" + NameB;
			
			while (NameC.toString().length < 3)
				NameC = "0" + NameC;
			
			while (NameD.toString().length < 3)
				NameD = "0" + NameD;
			
			document.getElementById("name").innerHTML += "<img class=\"name\" src=font/" + NameA + ".png></img>";
			document.getElementById("name").innerHTML += "<img class=\"name\" src=font/" + NameB + ".png></img>";
			document.getElementById("name").innerHTML += "<img class=\"name\" src=font/" + NameC + ".png></img>";
			document.getElementById("name").innerHTML += "<img class=\"name\" src=font/" + NameD + ".png></img>";
			
			// Frame Count (modulo 1024)
			
			if (FrameCount < 0 || FrameCount > 1023) {
